...
/*			
			//Image source
			Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.akihiko);
			//encode to byte[]
	        ...
	        ///*
	        //create ParseFile
	        final ParseFile file = new ParseFile("challenge", data);
	        ...
	        file.saveInBackground(new SaveCallback() {
				...
				public void done(ParseException e) {
					...
					challenge.put("from_user",ParseUser.getCurrentUser().getUsername());
					challenge.put("to_user", "Derp");  //!!!  // testing
					challenge.put("image", file);
