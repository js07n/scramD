package edu.fsu.cs.s4.ppgamev1;
...
public class MainActivity extends Activity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Fetch Image  
        //Convert to bitmap?
        Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.hxh); // not using! TEMP FILLER
        ...
        //chunk = bitmap.getWidth()/DIFFICULTY; //only works if image is 900x900
...
//            	Toast.makeText(getApplicationContext(), "P DOWN!", Toast.LENGTH_SHORT).show();
                break;
            case MotionEvent.ACTION_POINTER_UP:
//            	Toast.makeText(getApplicationContext(), "P UP", Toast.LENGTH_SHORT).show();
                break;
